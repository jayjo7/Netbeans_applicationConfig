...
//            new Customer(new UUID(0, 7), "Christine Farrow", "Down Dale", 2000)
            new Customer("1", "Fred Jones", "Here", 10),
            new Customer("2", "Jim Smith", "There", 100),
            new Customer("3", "Bill Bonner", "Where", 20),
            new Customer("4", "Sheila Williams", "In Town", 5000),
            new Customer("5", "Ella Barnard", "Countryside", 800),
            new Customer("6", "Freda Fredricksson", "Uphill", 700),
            new Customer("7", "Christine Farrow", "Down Dale", 2000)
        }) {
            data.put(x.getId(), x);
        }
    }
    ...
    public static List<Customer> getAll() {
        ...
        for (Map.Entry<String, Customer> e : data.entrySet()) {
            rv.add(e.getValue());
        }
        return rv;
    }

    public static Customer findByPrimaryKey(String pk) {
        return data.get(pk);
    }
    ...
    public static boolean removeByPrimaryKey(String uuid) {
